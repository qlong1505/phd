...
#define USB_CFG_HAVE_INTRIN_ENDPOINT    1 //needed for HID
 ...
 */
#define USB_CFG_INTR_POLL_INTERVAL      200  //why waste time
 ...
 */
#define USB_CFG_VENDOR_NAME     'w','w','w','.','p','j','r','a','d','c','l','i','f','f','e','.','w','o','r','d','p','r','e','s','s','.','c','o','m','/','o','p','e','n','-','u','s','b','-','i','o'
#define USB_CFG_VENDOR_NAME_LEN 41
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'O','p','e','n','-','U','S','B','-','I','O'
 ...
 * protocol.
 */
#define USB_CFG_HID_REPORT_DESCRIPTOR_LENGTH    78   /* total length of report descriptor */
